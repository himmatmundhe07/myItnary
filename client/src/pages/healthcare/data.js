...
export const SPECIALTIES = ["All", "General Physician", "Pediatrician", "Dermatology", "Orthopedic", "Dental Surgeon", "Emergency Medicine"];

export const USER_HEALTH_DATA = {
  name: "Priya Menon",
  age: 27,
  gender: "Female",
  bloodGroup: "B+",
  ...
  conditions: [
    { id: 1, name: "Mild Asthma", year: "2018", severity: "Managed", icon: "heart", color: "#C0392B" },
    { id: 2, name: "Lactose Intolerance", year: "2020", severity: "Ongoing", icon: "droplet", color: "#F0A500" },
    { id: 3, name: "Anxiety (Generalized)", year: "2022", severity: "Chronic", icon: "brain", color: "#2D6A4F" }
  ],
  medications: [
    { id: 1, name: "Salbutamol Inhaler", dosage: "100 mcg", frequency: "As needed", status: "Ongoing" },
    { id: 2, name: "Cetirizine", dosage: "10 mg", frequency: "Once daily", status: "Ongoing" },
    { id: 3, name: "Vitamin D3", dosage: "1000 IU", frequency: "Daily", status: "Supplement" }
  ],
  allergies: [
    { id: 1, name: "Penicillin", severity: "Severe" },
    { id: 2, name: "Shellfish", severity: "Moderate" },
    { id: 3, name: "Dust", severity: "Mild" },
    { id: 4, name: "Latex", severity: "Moderate" }
  ],
  consultations: [
    { id: 1, doctor: "Dr. Kavita Sharma", specialty: "General Physician", avatar: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=120&q=80", date: "May 14, 2025", location: "Udaipur, Rajasthan", notes: "Nausea and mild fever since yesterday...", ref: "#MYI-2025-0514-KS" },
    { id: 2, doctor: "Dr. Arjun Reddy", specialty: "Emergency Medicine", avatar: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=120&q=80", date: "March 2, 2025", location: "Jaisalmer, Rajasthan", notes: "Severe dehydration after camel safari...", ref: "#MYI-2025-0302-AR" },
    { id: 3, doctor: "Dr. Sunita Joshi", specialty: "Dental Surgeon", avatar: "https://images.unsplash.com/photo-1594824476967-48c8b964ac31?auto=format&fit=crop&w=120&q=80", date: "January 18, 2025", location: "Jodhpur, Rajasthan", notes: "Chipped tooth, mild pain on right side...", ref: "#MYI-2025-0118-SJ" }
  ],
  documents: [
    { id: 1, name: "Blood Test Report", date: "April 10, 2025", type: "PDF" },
    { id: 2, name: "Chest X-Ray", date: "March 3, 2025", type: "JPG" },
    { id: 3, name: "Prescription — Dr. Sharma", date: "May 14, 2025", type: "PDF" },
    { id: 4, name: "Insurance Card", date: "January 1, 2025", type: "JPG" }
  ]
};
